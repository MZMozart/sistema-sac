...
export function LandingHeader() {
  return (
    <header className="glass-strong landing-fixed-header fixed inset-x-0 top-0 z-50 border-b border-border/80">
      <div className="mx-auto flex min-h-20 max-w-7xl items-center justify-between px-4 md:px-8">
        <Logo size="sm" />
